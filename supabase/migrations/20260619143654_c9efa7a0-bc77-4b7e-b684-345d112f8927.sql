...
BEGIN
  ...
  -- Default escala com rate_per_minute para cobrir os 90s de carry-ahead.
  -- Antes era fixo em 500, o que limitava broadcasts de 3k/min a ~500/tick
  -- = ~1.1k–1.4k efetivos/min na prática. Agora cresce proporcionalmente.
