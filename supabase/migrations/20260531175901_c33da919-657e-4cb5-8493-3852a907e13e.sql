...
GRANT EXECUTE ON FUNCTION public.search_contacts_by_tag(uuid, uuid, text, text, text, integer, integer) TO service_role;
GRANT EXECUTE ON FUNCTION public.search_contacts_no_tag(uuid, text, text, text, integer, integer) TO service_role;